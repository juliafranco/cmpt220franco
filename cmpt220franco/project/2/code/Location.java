...
public class Location {
		...
		static Location[] places = 
			/**0*/{ new Location ( "The Cove Walkway" , "You are standing on the walkway in the cove, at the scene of your crime, next to the ladder "
					+ "to go \ndown. The walkway extends forward to where the lights hang from. Past the walkway and its railings \nis the top of "
					+ "the ceiling of the theatre below you. And under the walkway is the deepest depth of \nthe cove where your wrench lies." 
					, "You're back on the walkway, the area with the lights in front of you, with the ladder to go down right \nthere. And god, "
					+ "why is it so hot up here??"),
			/**1*/  new Location ("The Light Booth", "It's cold down here. The light board sits on the counter in front of the window overlooking "
					+ "the empty \ntheatre. There's a bunch of different stage lights just sitting around as well as a bunch of other things. "
					+ "\nThere's the ladder to go up to the cove, and at the other end are the stairs to go down to the theatre. \nTo your right, "
					+ "a door marked 'No exit, roof access only.'" , "You return to the light booth. A box sits at the base of the ladder up to the "
					+ "cove. \nNow that you look, there's a bunch of other things that maybe you could use here. \nAnd there's always the stairs "
					+ "down to the theatre and the door to the roof on your right."),
			/**2*/  new Location("The Theatre", "You are now in the empty theatre. You're surprised no one's in here, but that's actually a really "
					+ "lucky \nthing because you don't want to answer anyone's questions. The stage is in front of you, the green room out \nto "
					+ "your right. Behind you is the door to go out to the lounge outside and there's the stairs to go up to the \nlight booth.", 
					"You're back in the theatre. The stage is in front of you, the green room is to your right, the \nlounge is out the door behind "
					+ "you and there's always the stairs to go back to the lightbooth. It \ndoesn't seem like there's anything useful here, but you "
					+ "never know until you look..."),
			/**3*/  new Location("The Area of the Cove where the Lights Hang", "You duck under the pipe and sit on the ground, between the lights, "
					+ "looking down at the theatre below. \nThis is where people run the spot lights from -and someone left some stuff here. Maybe "
					+ "it's useful...." , "You pop back under the pipe and position yourself between the lights, on top the pillows that \nsomeone "
					+ "left up here. It's actually a really nice view, despite being small, dark, and hot. "),
			/**4*/  new Location("The Stage", "You find yourself standing on the stage, basking in the glory of finally getting your moment in \nthe "
					+ "spotlight.... except there's no spotlight on and your back is to the empty theatre but whatever. \nIn front of you is the "
					+ "backstage scene shop, to your right is out to the green room off stage.", "You stand on the empty stage once more, the shop "
					+ "before you, the theatre behind you and \nthe green room to your right. You really are just hoping that the stories about the "
					+ "theatre \nbeing haunted aren't true because you didn't wake up this morning and think 'I hope I get attacked \nby a ghost "
					+ "today.' Then again, you didn't think 'I hope I'll drop my wrench through the grating' \nbut that happened, so...."),
			/**5*/  new Location("The Abandoned Staples", "You break into the abandoned Staples at the far end of the shopping center. There's a "
					+ "swirling, glowing light. \nAnd then wrenches as far as the eye can see. This is the dimension of infinite wrenches. You reach "
					+ "out to ", "You managed to get back here. You're not supposed to be able to do that. I hope you enjoyed hacking my game."),
			/**6*/  new Location("The Lounge","You are now in the lounge outside the theatre and the green room. There's four couches, all of \nthem "
					+ "unoccupied. To your right is the office of Campus Security while to your left is the door \nto go outside to the campus green. "
					+ "Outside. The horror.", "You're back in the lounge. The couches look nice. Maybe someone dropped a wrench in one. Or, \ncheck "
					+ "the theatre in front of you, the campus green to your left, or campus security to your right."), 
			/**7*/  new Location("The Scene Shop", "SAWS EVERYWHERE. (the stage is behind you.)", "SAWS EVERYWHERE AND A DRILL TOO. (the stage "
					+ "is still behind you,)"),//TODO: Write real shop descriptions damn it. <-- nope. Those are the real ones now.
			...
			/**9*/  new Location("The Roof", "You pop out onto the roof. A cool wind ruffles your hair as you survey the world from the " 
					...
					+ "\nYou can also go through the door on your left to go back inside.", "You're back out on the roof. It's still pretty, but "
					+ "also chilly out here. Maybe you should use the door on your \nleft to go back inside."),
			/**10*/ new Location("The Parking Lot" , "You stand in the middle of the parking lot of the shopping center across the street "
					...
					+ "\nyou is Job Lot, and the other end of the parking lot is in front of you. Or you can go right to go \nback across the "
			...
			/**11*/ new Location("The other end of the parking lot", "You stand in the middle of the other end of the parking lot. It's kinda "
					+ "spooky down here... To your \nleft is the friendly looking Rite Aid. In front of you, is the decrepid and creepy looking "
					+ "abandoned \nStaples. The other end of the lot is behind you." , "You're back at the other end of the shopping center. You're "
					+ "still getting a weird vibe here, probably coming \nfrom the creepy abandoned Staples in front of you. The Rite Aid to your "
					+ "left looks nice and \njust turning around and going back to where you came from isn't a bad plan either.", true), 
			/**12*/ new Location("The Depths of the Hudson" , "You jump out the window and right into the Hudson... somehow. This probably wasn't "
					+ "a \ngood idea, but whatever. It's fine. The water's nice and the kitchen's to your right", "You jump back into the Hudson "
					+ "for... some... reason...??"), //Depths of the Hudson
			...
			/**14*/ new Location ("The Green Room", "You are now in the backstage green room. It's not green. It's really just a room backstage. "
					+ "There's a \nbathroom in front of you, the door out to the lounge behind you, and the stage is out to your left.", "You're "
					+ "back in the green room. It's still not green. The bathroom's in front of you, the stage is \nto your right, and the lounge is "
					+ "through the door behind you."), //the green room
            /**15*/ new Location ("The Living Room of K1","You practically barge into the nearest townhouse in Lower New- K1. It's a cozy living "
            		...
            		+ "open...or what kind of useful things could be here. The kitchen is behind you, there's a \nflight of stairs up to the second "
            		+ "floor in front of you, or you can go forward to go back outside.","You're back in the living room. There's some couches and a "
            		+ "few cushy chairs and a TV. No humans though. \nThe front door out to the green is in front of you, the kitchen is behind you, "
            		+ "and you can always go up \nto the second floor."),
            /**16*/ new Location ("The K1 Kitchen","You find yourself in the kitchen. It's a pretty nice, standard kitchen. Two refridgerators, a "
            		...
            		+ "\nof you is the living room. Another option is going out the window to your left and going into the Hudson.","You're back in "
            		+ "the kitchen. There seems to be more trash than before but beyond that it's unchanged. \nLiving room's in front of you, the "
            		+ "river's out the window to your left. There has to be something useful here..."),
            /**17*/ new Location ("The Upstairs Landing","This is the second floor at the top of the stairs. An open bedroom door to your right, the "
            		+ "bathroom \nbehind you.","You're back on the landing. There's still an open bedroom door to your right and the bathroom behind "
            		+ "you. \nThere's a sink in front of you, but who knows how useful that'll be."),
            /**18*/ new Location ("Bedroom B","An innocent bedroom in a townhouse. It's a little messy and definitly don't have bottles of Smirnoff "
            		+ "\nhiding in it. The landing is to your left.","You're back in the bedroom. It's quaint, still kinda messy, and why is there a "
            		+ "horde of crocheted Daleks \nstaring at you from one of the beds. You can always retreat to the landing on your left, or just "
            		+ "jump out the window...."),
            /**19*/ new Location ("The Upstairs bathroom","You find yourself in the bathroom with the normal bathroom things. There's nothing "
            		+ "bizarre in here, \nbut maybe something useful. Or just the landing in front of you.","You're in the bathroom once more. What "
            		+ "lurks in a bathroom, only time will tell... (or, you know, just exit forward.)"),
            /**20*/ new Location ("The Office of Campus Security","You are now in the office of campus security, home of the lost and found and the "
            		+ "people you complain \nto about getting unjustified parking tickets. If you have issues, they're here. The lounge is to your "
            		+ "left.","You're back in the office of campus security. Useful if you feel unsafe or just have a zillion \nquestions. Or if you "
            		+ "lost your phone. There is still the lounge through the door on your left."), //sole purpose at this point is it's a logical 
            			//place to put a map.
            /**21*/ new Location ("The Construction Site","You sneak into the luckily deserted construction site. There's a variety of construction "
            		...
            		+ "\nconstruction site because they're pretty cool. Will give you bragging rights when your friends end up \nliving here after "
            		+ "next year. The green is behind you.","You return to the construction site. Next year, there will be new dorms here. But right "
            		+ "now? All the construction \nsupplies you think no one would miss. If you go backward, you'll be on the green."), 
            /**22*/ new Location ("Rite Aid"," You find yourself inside Rite Aid. There are many useful things in Rite Aid. And the parking lot is "
            		+ "out to your right.","You're back inside the Rite Aid. There's also discount candy and the parking lot to your right."),
            /**23*/ new Location ("Ocean State Job Lot","Behold! It is the majesty of the Ocean State Job Lot. It sells an eclectic assortment of "
            		+ "things at a price \nthat can't be beat. There's something about it that acts as a beacon for bored college students on lazy "
            		+ "nights. \nWhat lies within? Why don't you find out? Or just go forward to go back outside.","You are back in Job Lot. You're "
            		+ "definitely going to find more weird stuff here than before. The parking lot is in front of you, but you also wonder \nwhat "
            		+ "lies below..."),
            /**24*/ new Location ("Home Depot","Welcome to Home Depot. There are lots of tools and building supplies because that's what Home Depot "
            		+ "sells. Or you can go back out to the parking lot to your right","You're back in Home Depot, the one stop shop for a lot of "
            		+ "home improvement needs. Or just go back out to the parking lot to your right."), 
            /**25*/ new Location ("Lola's Cafe","You are in Lola's cafe, a wonderful little cafe with amazing food and peanut noodles to die for.",
            		"You arrive back at Lola's ready for more of this great food.", true), 
            ...
            /**27*/ new Location ("Wawa" ,"You arrive at the one beautiful thing that's worth visiting in New Jersey (besides the beach)- Wawa, the "
            		+ "one in Lodi to be exact. Wawa has a lot of food, all of it equally delicious. Why don't you have a look around to see just "
            		+ "what's in store?", "You arrive back at Wawa, ready to acquire more food from from this magical paradise.", true) 
			}; 
